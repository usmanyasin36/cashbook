...
@Database(entities = {Category.class,Account.class, Inventory.class, CashBook.class},version = 3)
@TypeConverters({Converters.class})
public abstract class CashbookDatabase extends RoomDatabase {
    ...
    private static CashbookDatabase instance;

    public static synchronized CashbookDatabase getInstance(Context context) {
        if (instance == null) {
            instance = Room.databaseBuilder(context.getApplicationContext(),
                    CashbookDatabase.class, "books_database")
    ...
    /*private static class InitialDataAsyncTask extends AsyncTask<Void,Void,Void> {
        ...
        public InitialDataAsyncTask(CashbookDatabase booksDatabase) {
